(function() {
	...
	function SaleEditController( $scope, $routeParams, $location, customerDB ){
		var ctrl = this;
	...
	.component('saleEdit',{
		...
		controller : ['$scope', '$routeParams', '$location', 'customerDB', SaleEditController]
	})
