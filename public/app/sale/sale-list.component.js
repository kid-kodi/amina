(function() {
	...
	function SaleListController( saleDB, $routeParams, $scope, $http, $compile ){
		var ctrl = this;
		ctrl.editMode   = false;
	...
	.module('saleList')
	.component('saleList',{
		templateUrl : 'sale/sale-list.template.html',
		controller : ['saleDB', '$routeParams', '$scope', '$http', '$compile', SaleListController]	
	})
