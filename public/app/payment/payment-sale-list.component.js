(function() {
	...
	function PaymentSaleListcontroller( saleDB, $routeParams, $scope, $http, $compile ){
		var ctrl = this;
		ctrl.editMode   = false;
	...
	angular
	.module('paymentSaleList')
	.component('paymentSaleList',{
		templateUrl : 'payment/payment-sale-list.template.html',
		controller : ['saleDB', '$routeParams', '$scope', '$http', '$compile', PaymentSaleListcontroller]	
	})
