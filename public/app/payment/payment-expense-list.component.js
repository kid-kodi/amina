(function() {
	...
	function PaymentExpenseListcontroller( expenseDB, $routeParams, $scope, $http, $compile ){
		var ctrl = this;
		ctrl.editMode   = false;
	...
	angular
	.module('paymentExpenseList')
	.component('paymentExpenseList',{
		templateUrl : 'payment/payment-expense-list.template.html',
		controller : ['expenseDB', '$routeParams', '$scope', '$http', '$compile', PaymentExpenseListcontroller]	
	})
